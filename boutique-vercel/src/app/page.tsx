          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Directement de nos fermes partenaires pour une fraîcheur garantie
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Commandez facilement via WhatsApp et recevez rapidement
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Sélection rigoureuse pour vous offrir le meilleur
              </p>
            </div>
          </div>
        </div>
