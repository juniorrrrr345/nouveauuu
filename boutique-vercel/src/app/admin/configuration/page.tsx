            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    type="text"
                    defaultValue={getConfigValue('address', '')}
                    placeholder="Votre adresse complète"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500"
                    onBlur={(e) => saveConfig('address', e.target.value)}
                  />
                  <button
                    onClick={(e) => {
                      const input = e.currentTarget.parentElement?.querySelector('input') as HTMLInputElement;
                      saveConfig('address', input.value);
                    }}
                    disabled={saving === 'address'}
                    className="ml-2 px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50"
                  >
                    {saving === 'address' ? '...' : <FiSave size={16} />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    type="text"
                    defaultValue={getConfigValue('phone', '')}
                    placeholder="ex: +33 1 23 45 67 89"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500"
                    onBlur={(e) => saveConfig('phone', e.target.value)}
                  />
                  <button
                    onClick={(e) => {
                      const input = e.currentTarget.parentElement?.querySelector('input') as HTMLInputElement;
                      saveConfig('phone', input.value);
                    }}
                    disabled={saving === 'phone'}
                    className="ml-2 px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50"
                  >
                    {saving === 'phone' ? '...' : <FiSave size={16} />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    type="email"
                    defaultValue={getConfigValue('email', '')}
                    placeholder="contact@boutique.com"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500"
                    onBlur={(e) => saveConfig('email', e.target.value)}
                  />
                  <button
                    onClick={(e) => {
                      const input = e.currentTarget.parentElement?.querySelector('input') as HTMLInputElement;
                      saveConfig('email', input.value);
                    }}
                    disabled={saving === 'email'}
                    className="ml-2 px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50"
                  >
                    {saving === 'email' ? '...' : <FiSave size={16} />}
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  <input
                    type="text"
                    defaultValue={getConfigValue('schedule', '')}
                    placeholder="ex: Lun-Ven: 9h-18h, Sam: 9h-12h"
                    className="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500"
                    onBlur={(e) => saveConfig('schedule', e.target.value)}
                  />
                  <button
                    onClick={(e) => {
                      const input = e.currentTarget.parentElement?.querySelector('input') as HTMLInputElement;
                      saveConfig('schedule', input.value);
                    }}
                    disabled={saving === 'schedule'}
                    className="ml-2 px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50"
                  >
                    {saving === 'schedule' ? '...' : <FiSave size={16} />}
                  </button>
                </div>
              </div>
            </div>
